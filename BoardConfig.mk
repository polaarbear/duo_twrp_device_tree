...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := surfaceduo
...
TARGET_PREBUILT_KERNEL := device/microsoft/duo/prebuilt/kernel
...
# FSTAB
TARGET_RECOVERY_FSTAB := $(TARGET_DEVICE_DIR)/recovery.fstab
BOARD_RECOVERYIMAGE_BUILD_FSTAB := $(TARGET_RECOVERY_FSTAB)
